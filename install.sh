#!/usr/bin/env sh
# Universal installer for narrativediff. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/narrativediff.git"
echo "Installing narrativediff ..."
...
echo "Done. Run: narrativediff --help"
